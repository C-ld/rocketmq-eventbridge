...
namespace RocketMQ.Eventbridge.Demo
{
    public class Demo 
    {
        protected AlibabaCloud.OpenApiClient.Models.Config _config;
        ...
        public Demo()
        {
            ...
            this._config = new AlibabaCloud.OpenApiClient.Models.Config
            {
                Endpoint = _endpoint,
            };
            this._sdkClient = new RocketMQ.Eventbridge.SDK.SDKClient(_config);
        }
        ...
        static void Main(string[] args){
            ...
            AlibabaCloud.TeaConsole.Client.Log("hello!");
        }
